...
In all five cases, the 5-file write sequence and the schemas are unchanged. Missing inputs affect what you write in each file, not how many files you write or which schema each file conforms to.
